...
const TilesListBasicExampleCode = require('!raw-loader!office-ui-fabric-react-experiments/src/components/TilesList/examples/TilesList.Basic.Example.tsx') as string;

import { TilesListDocumentExample } from './examples/TilesList.Document.Example';
const TilesListDocumentExampleCode = require('!raw-loader!office-ui-fabric-react-experiments/src/components/TilesList/examples/TilesList.Document.Example.tsx') as string;

import { TilesListMediaExample } from './examples/TilesList.Media.Example';
const TilesListMediaExampleCode = require('!raw-loader!office-ui-fabric-react-experiments/src/components/TilesList/examples/TilesList.Media.Example.tsx') as string;
    ...
    return (
      <ComponentPage
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={ [
              require<string>('!raw-loader!office-ui-fabric-react-experiments/src/components/TilesList/TilesList.Props.ts')
            ] }
          />
        }
        overview={
