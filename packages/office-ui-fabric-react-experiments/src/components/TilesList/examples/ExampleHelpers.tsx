...
import { TilesGridMode, ITilesHeaderItem, ITilesGridItem, ITilesGridSegment, ITileSize } from '../TilesList.Props';
...
export function getTileCells(groups: IExampleGroup[], {
  ...
  const items: (ITilesGridSegment<IExampleItem> | ITilesHeaderItem<IExampleItem>)[] = [];

  for (const group of groups) {
    const header: ITilesHeaderItem<IExampleItem> = {
