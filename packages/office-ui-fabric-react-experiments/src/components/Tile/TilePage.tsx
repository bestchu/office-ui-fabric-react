...
const TileMediaExampleCode = require('!raw-loader!office-ui-fabric-react-experiments/src/components/Tile/examples/Tile.Media.Example.tsx') as string;

import { TileDocumentExample } from './examples/Tile.Document.Example';
const TileDocumentExampleCode = require('!raw-loader!office-ui-fabric-react-experiments/src/components/Tile/examples/Tile.Document.Example.tsx') as string;
    ...
    return (
      <ComponentPage
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={ [
              require<string>('!raw-loader!office-ui-fabric-react-experiments/src/components/Tile/Tile.Props.ts')
            ] }
          />
        }
        overview={
